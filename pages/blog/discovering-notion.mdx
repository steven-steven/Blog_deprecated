...
export const meta = {  date: '2019-02-25',  title: 'Discovering Notion'  };
...
A website-like interface, you can make tables, database, Kanban board, gallery, calendar, bookmark, LaTex, markdown, pages, breadCrumbs, audio, video, code, ... I might just be rambling but man this is what an ALL-IN-ONE really looks like :man_dancing:
...
I then played around with it on my own, and I've created my own workspace where I bookmark things to read, keep track of my OKR, write class/review notes, and a whole fancy database x Kanban where I can assign, filter and sort my tasks based on subect, difficulty level, priority, and status. 
...
Below that, I have a TODO table. I can easily add new task, assign attributes (class, due, progress, etc.) through a customized list of options you created. This can be used to sort and filter. Basically this thing IS a database! 

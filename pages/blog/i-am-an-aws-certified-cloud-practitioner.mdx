...
My first actual use of AWS was 8 months ago when i tried to provision a RDS MySQL DB instance for a course project ([ECE 356](https://stevenwhat.me/blog/when-the-storm-ends#4.-database-sql---ece-356)). I had to import ~2 GB of sanitized Yelp data which was painfully slow locally (hours). But to my surprise, it took less than 5 min in RDS! 
